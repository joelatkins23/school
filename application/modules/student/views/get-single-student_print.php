                ...
                <div class="admission-form" >
                    <table width="1100px" style="margin:auto;margin-top:80px;">
                        ...
                        <tr>
                            ...
                            <td width="60%" class="text-center">
                                ...
                                <div><h4><?php echo 'Formulário de Matrícula' ?></h4></div>
                            </td>
                    ...
                    <table width="1100px" style="margin:auto;margin-bottom: 100px;">
                        <tr  >
                            ...
                            <td >
                                <p class="admission-form-title text-right" class="text-right" ><strong><?php echo 'Matrícula' ?> <?php echo $this->lang->line('no'); ?>: &nbsp;<?php echo $student->id; ?>&nbsp;</strong></p>
