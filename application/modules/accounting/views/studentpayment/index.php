                                ...
                                <div class="row">
                                    <div class="col-md-6" style="padding:30px 50px;">
                                        ...
                                        <div class="item form-group" id='month_select_form'>
                                            ...
                                            <div class="input-group">  
                                                ...
                                                <span class="input-group-btn">
                                                    <button class="btn btn-info" type="button" id='monpay_btn'>submit</button>
                                                </span>
                                            </div>   
                                        </div>
                                        <div class="item form-group">
                                            <label class="control-label  text-left" for="sales_price"><?php echo $this->lang->line('product'); ?> <?php echo $this->lang->line('sales'); ?> <?php echo $this->lang->line('price'); ?></label>
                                            <div class="">
                                                <div class="input-group">                                                    
                                                    <select  class="form-control"  id="sales_price" style='width:100%'>
                                                        <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                                    ...
                                                    <span class="input-group-btn">
                                                        <button class="btn btn-info" type="button" id='productpay_btn'>submit</button>
                                                    </span>
                                                </div>
                                        ...
                                        <div class="item form-group" id="amount_payable_select">
                                            ...
                                            <div class="">
                                                <input  class="form-control col-md-7 col-xs-12"    id="amount_paypable_course_fee" value="0" placeholder=""  type="text" autocomplete="off" disabled>
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                           <div class="row">
