        ...
        <div class="x_panel">
            ...
            <?php $this->load->view('quick_report'); ?>
             <div class="x_content filter-box  no-print"> 
                <?php echo form_open_multipart(site_url('report/listsubscriptions'), array('name' => 'sbalance', 'id' => 'sbalance', 'class' => 'form-horizontal form-label-left'), ''); ?>
                <div class="row"> 
                           ...
                           <div class="col-sm-6  col-xs-6 layout-box">
                               <div>
                                 ...
                                 <?php } ?>
                                   ...
                                   <h6 class="head-title ptint-title" style="width: 50;"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('list'); ?> <?php echo $this->lang->line('subscriptions'); ?> <?php echo $this->lang->line('report'); ?></small></h3>                
