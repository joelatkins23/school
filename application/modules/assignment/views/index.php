                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_assignment">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('assignment/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="course_id"><?php echo $this->lang->line('course'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="course_id"  id="add_course_id" required="required"  >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($courses as $obj ){ ?>
                                             
                                                <option value="<?php echo $obj->id; ?>" <?php echo isset($post['course_id']) && $post['course_id'] == $obj->id ?  'selected="selected"' : ''; ?>><?php echo $obj->name; ?></option>
                                            <?php } ?> 
                                        </select>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('assignment/edit/'.$assignment->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="course_id"  id="edit_course_id" required="required"  >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($courses as $obj ){ ?>                                             
                                                <option value="<?php echo $obj->id; ?>" <?php echo isset($assignment->course_id) && $assignment->course_id == $obj->id ?  'selected="selected"' : ''; ?>><?php echo $obj->name; ?></option>
                                            <?php } ?> 
                                        </select>
                                        <div class="help-block"><?php echo form_error('course_id'); ?></div>
                                    </div>
  ...
  $('#edit_deadline').datepicker();
   ...
   /* Menu Filter Start */
    ...
    <?php if(isset($filter_school_id) && isset($class_id)){ ?>
        get_class_by_school('1', '<?php echo $class_id; ?>');
    <?php } ?>
